...
var
  ...
  begin
    case s of
      ...
      btU32: Result := 'U32';
      btS32: Result := 'S32';
      {$IFNDEF NOINT64}bts64: Result := 'S64'; {$ENDIF}
      ...
      var
        ...
        begin
          ...
          case f^.BaseType of
            ...
            {$IFNDEF NOINT64}bts64: begin if not ReadData(ff, 8) then exit; Result := IntToStr(ff); end;{$ENDIF}

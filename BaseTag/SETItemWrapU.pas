...
type
  TSETItemWrap = class(TRTItemWraper)
  private
...
function TSETItemWrap.setchange(key: integer; val: string): string;
begin
   result:='';
...
function TSETItemWrap.GetTypL(Index: Integer): String;
begin
    result:=InttoTypLog(LogTime[Index]);
end;

procedure TSETItemWrap.SetTypL(Index: Integer; value: String);
begin
   LogTime[Index]:=TypLogtoInt(value);
end;


function TSETItemWrap.GetTypL_(): String;
var i: integer;
begin
     result:=TypL[0];
...
procedure TSETItemWrap.SetTypL_( value: String);
var i: integer;
begin

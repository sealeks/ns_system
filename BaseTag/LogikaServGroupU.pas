unit LogikaServGroupU;

interface

uses
  Classes,SimpleGroupAdapterU,SysUtils,StrUtils,ItemAdapterU, LogikaClasses, InterfaceServerU;
...
type
  TLogikaServGroup = class(TGroupWraper)
  private
    com: TCOMSet;
...
function TLogikaServGroup.getCom(i: integer): TCOMSet;
begin
...
procedure TLogikaServGroup.setMap();
begin
       ...
       //  setPropertys('Конечная минута часового цикла опроса',Stop_);
        // setPropertys('PRTTM',PRTTM_);
         ...
         setPropertys('Приложение','NS_LogikaIOServ.exe/NS_LogikaIOServ_app.exe',true);
         setNew();


end;

function TLogikaServGroup.setchange(key: integer; val: string): string;
begin
   result:='';
 ...
 //  9: FlowControlAfterSleep_:=val;
   7: ReadInterval_:=val;
   8: ReadTotalMultiplier_:=val;
   9: ReadTotalConstant_:=val;
   10: WriteTotalMultiplier_:=val;
   11: WriteTotalConstant_:=val;
   12: BlockSize_:=val;
   13: ArchBlockSize_:=val;
   14: ReadTimeout_:=val;
   15: TryCount_:=val;
  // 13: Start_:=val;
  // 14: Stop_:=val;
...
procedure TLogikaServGroup.SetType;
var i: integer;
begin   
  Application_:='LogikaServ';
  Topic_:='com[com1,bd8,pt2,trd0,red0,ri300,rtm800,rtc800,wtm800,wtc800]';
end;


function TLogikaServGroup.GetSyncTime(Index: Integer): boolean;
...
procedure TLogikaServGroup.SetSyncTime(Index: Integer; value: boolean);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
...
function TLogikaServGroup.GetSyncTime_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetSyncTime_( value: String);
var i: integer;
begin
...
function TLogikaServGroup.GetComN(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.Com;
...
procedure TLogikaServGroup.SetComN(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.Com:=value;
...
function TLogikaServGroup.GetComN_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetComN_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetBaudRate(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.br;
...
procedure TLogikaServGroup.SetBaudRate(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.br:=value;
...
function TLogikaServGroup.GetBaudRate_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetBaudRate_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetMaxAddr(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.db;
...
procedure TLogikaServGroup.SetMaxAddr(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.db:=value;
...
function TLogikaServGroup.GetMaxAddr_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetMaxAddr_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetConnType(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.sb;
...
procedure TLogikaServGroup.SetConnType(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.sb:=value;
...
function TLogikaServGroup.GetConnType_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetConnType_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetArchBlockSize(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.pt;
...
procedure TLogikaServGroup.SetArchBlockSize(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.pt:=value;
...
function TLogikaServGroup.GetArchBlockSize_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetArchBlockSize_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetFlowControl(Index: Integer): boolean;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.flCtrl;
...
procedure TLogikaServGroup.SetFlowControl(Index: Integer; value: boolean);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     if (value) then
...
function TLogikaServGroup.GetFlowControl_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetFlowControl_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetFlowControlBeforeSleep(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.trd;
...
procedure TLogikaServGroup.SetFlowControlBeforeSleep(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.trd:=value;
...
function TLogikaServGroup.GetFlowControlBeforeSleep_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetFlowControlBeforeSleep_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetFlowControlAfterSleep(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.red;
...
procedure TLogikaServGroup.SetFlowControlAfterSleep(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.red:=value;
...
function TLogikaServGroup.GetFlowControlAfterSleep_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetFlowControlAfterSleep_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetReadInterval(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.ri;
...
procedure TLogikaServGroup.SetReadInterval(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.ri:=value;
...
function TLogikaServGroup.GetReadInterval_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetReadInterval_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetReadTotalMultiplier(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.rtm;
...
procedure TLogikaServGroup.SetReadTotalMultiplier(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.rtm:=value;
...
function TLogikaServGroup.GetReadTotalMultiplier_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetReadTotalMultiplier_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetReadTotalConstant(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.rtc;
...
procedure TLogikaServGroup.SetReadTotalConstant(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.rtc:=value;
...
function TLogikaServGroup.GetReadTotalConstant_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetReadTotalConstant_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetWriteTotalMultiplier(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.wtm;
...
procedure TLogikaServGroup.SetWriteTotalMultiplier(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.wtm:=value;
...
function TLogikaServGroup.GetWriteTotalMultiplier_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetWriteTotalMultiplier_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetWriteTotalConstant(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.wtc;
...
procedure TLogikaServGroup.SetWriteTotalConstant(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.wtc:=value;
...
function TLogikaServGroup.GetWriteTotalConstant_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetWriteTotalConstant_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetBlockSize(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.bs;
...
procedure TLogikaServGroup.SetBlockSize(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.bs:=value;
...
function TLogikaServGroup.GetBlockSize_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetBlockSize_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetReadTimeout(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.frt;
...
procedure TLogikaServGroup.SetReadTimeout(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.frt:=value;
...
function TLogikaServGroup.GetReadTimeout_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetReadTimeout_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetProxy(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.frd;
...
procedure TLogikaServGroup.SetProxy(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.frd:=value;
...
function TLogikaServGroup.GetProxy_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetProxy_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetTryCount(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.trc;
...
procedure TLogikaServGroup.SetTryCount(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.trc:=value;
...
function TLogikaServGroup.GetTryCount_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetTryCount_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetStart(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.tstrt;
...
procedure TLogikaServGroup.SetStart(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.tstrt:=value;
...
function TLogikaServGroup.GetStart_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetStart_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetStop(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.tstp;
...
procedure TLogikaServGroup.SetStop(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.tstp:=value;
...
function TLogikaServGroup.GetStop_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetStop_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetPRTTM(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.prttm;
...
procedure TLogikaServGroup.SetPRTTM(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.prttm:=value;
...
function TLogikaServGroup.GetPRTTM_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetPRTTM_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.GetWait(Index: Integer): integer;
var int_temp: integer;
begin
    getCom(Index);
    result:= com.wait;
...
procedure TLogikaServGroup.SetWait(Index: Integer; value: integer);
var com_: TCOMSet;
begin
     com_:=getCom(Index);
     com_.wait:=value;
...
function TLogikaServGroup.GetWait_(): String;
var i: integer;
begin
...
procedure TLogikaServGroup.SetWait_( value: String);
var i: integer;
begin
   for i:=0 to idscount-1 do
...
function TLogikaServGroup.getTopic_conf(val: TCOMSet): string;
begin
   {ComSet.br:=9600;
   ComSet.db:=7;
   ComSet.sb:=1;
...
function TLogikaServGroup.getApplication_conf(): string;
begin
    result:='LogikaServ';;
end;

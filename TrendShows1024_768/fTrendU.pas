...
begin
 ...
 if (ExprGraphMulti1.Caption<>'Пусто') then
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti1.Caption)^.eu,[chart1.Series[0].YValues.Value[indx-1]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti2.Caption)^.eu,[chart1.Series[1].YValues.Value[indx-1]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti3.Caption)^.eu,[chart1.Series[2].YValues.Value[indx-1]]);
      end
    end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti4.Caption)^.eu,[chart1.Series[3].YValues.Value[indx-1]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti5.Caption)^.eu,[chart1.Series[4].YValues.Value[indx-1]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti6.Caption)^.eu,[chart1.Series[5].YValues.Value[indx-1]]);
       end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti7.Caption)^.eu,[chart1.Series[6].YValues.Value[indx-1]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti8.Caption)^.eu,[chart1.Series[7].YValues.Value[indx-1]]);
      end else
      exit;
   end;

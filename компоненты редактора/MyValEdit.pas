...
uses Windows, SysUtils, Classes, Messages, Controls, MyGrids, Grids , StdCtrls;
...
{ TMyValueListEditor }
  ...
  TMyValueListEditor = class(TCustomDrawGrid)
  private
    FTitleCaptions: TStrings;
    FStrings: TMyValueListStrings;
  ...
  protected
    ...
    function CreateEditor: TMyInplaceEdit;
    ...
    property EditList: TMyInplaceEditList read FEditList;
  public
    ...
    property ItemProps[const KeyOrIndex: Variant]: TMyItemProp read GeTMyItemProp write PuTMyItemProp;
  ...
  (*$HPPEMIT 'class DELPHICLASS TMyItemProp;' *)

{ TMyValueListStrings }

  TMyItemProps = array of TMyItemProp;

  TMyValueListStrings = class(TStringList)
  private
    FItemProps: TMyItemProps;
    FEditor: TMyValueListEditor;
    function GeTMyItemProp(const KeyOrIndex: Variant): TMyItemProp;
    procedure PuTMyItemProp(const KeyOrIndex: Variant; const Value: TMyItemProp);
  protected
    procedure Changed; override;
    procedure Changing; override;
    function FindItemProp(const KeyOrIndex: Variant; Create: Boolean = False): TMyItemProp;
    procedure InsertItem(Index: Integer; const S: string; AObject: TObject); override;
    procedure Put(Index: Integer; const S: String); override;
  public
    constructor Create(AEditor: TMyValueListEditor); reintroduce;
...
{ TMyItemProp }
  ...
  public
    constructor Create(AEditor: TMyValueListEditor);
    destructor Destroy; override;
...
constructor TMyValueListEditor.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
  FStrings := TMyValueListStrings.Create(Self);
...
destructor TMyValueListEditor.Destroy;
begin
  inherited;
  FTitleCaptions.Free;
  FStrings.Free;
...
function TMyValueListEditor.CreateEditor: TMyInplaceEdit;
begin
  FEditList := TMyInplaceEditList.Create(Self);
...
function TMyValueListEditor.IsEmptyRow: Boolean;
begin
  Result := ((Row - FixedRows) < Strings.Count) and
    (Cells[0, Row] = '') and (Cells[1, Row] = '');
end;

function TMyValueListEditor.FindRow(const KeyName: string;
...
function TMyValueListEditor.GetColCount: Integer;
begin
  Result := inherited ColCount;
end;

function TMyValueListEditor.GetRowCount: Integer;
begin
  Result := inherited RowCount;
end;

function TMyValueListEditor.GetCell(ACol, ARow: Integer): string;
var
  Index: Integer;
  ValPos: Integer;
begin
...
procedure TMyValueListEditor.SetCell(ACol, ARow: Integer;
  const Value: string);
var
  Index: Integer;
  Line: string;
...
procedure TMyValueListEditor.SetDropDownRows(const Value: Integer);
begin
  FDropDownRows := Value;
...
function TMyValueListEditor.GetKey(Index: Integer): string;
begin
  Result := GetCell(0, Index);
end;

procedure TMyValueListEditor.SetKey(Index: Integer; const Value: string);
begin
  SetCell(0, Index, Value);
end;

function TMyValueListEditor.GetValue(const Key: string): string;
var
  I: Integer;
begin
...
procedure TMyValueListEditor.SetValue(const Key, Value: string);
var
  I: Integer;
begin
...
procedure TMyValueListEditor.SetTitleCaptions(const Value: TStrings);
begin
  FTitleCaptions.Assign(Value);
  Refresh;
end;

function TMyValueListEditor.TitleCaptionsStored: Boolean;
begin
  Result := TitleCaptions.Text <> (SKeyCaption+SLineBreak+SValueCaption+SLineBreak);
end;

function TMyValueListEditor.GetStrings: TStrings;
begin
  Result := FStrings;
end;

procedure TMyValueListEditor.SetStrings(const Value: TStrings);
begin
  FStrings.Assign(Value);
end;

procedure TMyValueListEditor.SetDisplayOptions(const Value: TDisplayOptions);
...
function TMyValueListEditor.GeTMyItemProp(const KeyOrIndex: Variant): TMyItemProp;
begin
  Result := FStrings.GeTMyItemProp(KeyOrIndex);
end;

procedure TMyValueListEditor.PuTMyItemProp(const KeyOrIndex: Variant; const Value: TMyItemProp);
begin
  FStrings.PuTMyItemProp(KeyOrIndex, Value);
end;

procedure TMyValueListEditor.SetKeyOptions(Value: TKeyOptions);
begin
...
function TMyValueListEditor.GetOnStringsChange: TNotifyEvent;
begin
  Result := FStrings.OnChange;
end;

function TMyValueListEditor.GetOnStringsChanging: TNotifyEvent;
begin
  Result := FStrings.OnChanging;
end;

procedure TMyValueListEditor.SetOnStringsChange(const Value: TNotifyEvent);
begin
  FStrings.OnChange := Value;
end;

procedure TMyValueListEditor.SetOnStringsChanging(const Value: TNotifyEvent);
begin
  FStrings.OnChanging := Value;
end;

procedure TMyValueListEditor.SetOnEditButtonClick(const Value: TNotifyEvent);
begin
...
procedure TMyValueListEditor.DrawCell(ACol, ARow: Integer; ARect: TRect;
  AState: TGridDrawState);
var
  CellText: string;
  ItemProp: TMyItemProp;
begin
...
procedure TMyValueListEditor.AdjustColWidths;
...
procedure TMyValueListEditor.AdjustRowCount;
var
  NewRowCount: Integer;
begin
...
procedure TMyValueListEditor.Resize;
begin
  inherited;
  AdjustColWidths;
end;

procedure TMyValueListEditor.ColWidthsChanged;
begin
  AdjustColWidths;
  inherited;
end;

procedure TMyValueListEditor.Refresh;
begin
...
procedure TMyValueListEditor.StringsChanging;
begin
  HideEdit;
end;
...
function TMyValueListEditor.CanEditModify: Boolean;
var
  ItemProp: TMyItemProp;
begin
...
procedure TMyValueListEditor.DisableEditUpdate;
begin
  if FEditUpdate = 0 then
...
procedure TMyValueListEditor.EnableEditUpdate;
begin
  Dec(FEditUpdate);
...
function TMyValueListEditor.GetEditLimit: Integer;
var
  ItemProp: TMyItemProp;
begin
  ItemProp := FStrings.FindItemProp(Row-FixedRows);
...
function TMyValueListEditor.GetEditMask(ACol, ARow: Integer): string;
var
  ItemProp: TMyItemProp;
begin
  ItemProp := FStrings.FindItemProp(Row-FixedRows);
...
function TMyValueListEditor.GetEditStyle(ACol, ARow: Integer): TEditStyle;
var
  ItemProp: TMyItemProp;
begin
  Result := esSimple;
...
function TMyValueListEditor.GetEditText(ACol, ARow: Longint): string;
begin
  Result := Cells[ACol, ARow];
  if Assigned(OnGetEditText) then OnGetEditText(Self, ACol, ARow, Result);
end;

procedure TMyValueListEditor.SetEditText(ACol, ARow: Longint; const Value: string);
begin
...
procedure TMyValueListEditor.EditListGetItems(ACol, ARow: Integer;
  Items: TStrings);
var
  ItemProp: TMyItemProp;
begin
...
function TMyValueListEditor.GetPickList(Values: TStrings;
...
function TMyValueListEditor.InsertRow(const KeyName, Value: string;
...
procedure TMyValueListEditor.DeleteRow(ARow: Integer);
begin
...
function TMyValueListEditor.RestoreCurrentRow: Boolean;
...
procedure TMyValueListEditor.RowMoved(FromIndex, ToIndex: Longint);
begin
  Strings.Move(FromIndex, ToIndex);
  inherited RowMoved(FromIndex, ToIndex);
end;

procedure TMyValueListEditor.DoOnValidate;
begin
...
function TMyValueListEditor.SelectCell(ACol, ARow: Integer): Boolean;
begin
...
procedure TMyValueListEditor.KeyDown(var Key: Word; Shift: TShiftState);
...
function TMyValueListEditor.GetOptions: TGridOptions;
begin
  Result := inherited Options;
end;

procedure TMyValueListEditor.SetOptions(const Value: TGridOptions);
begin
...
procedure TMyValueListEditor.CreateWnd;
begin
  inherited;
...
procedure TMyValueListEditor.DoExit;
begin
  try
    DoOnValidate;
  except
...
procedure TMyValueListEditor.CMShowingChanged(var Message: TMessage);
begin
  inherited;
  if Showing then
    AdjustColWidths;
...
constructor TMyValueListStrings.Create(AEditor: TMyValueListEditor);
begin
  FEditor := AEditor;
  inherited Create;
end;

procedure TMyValueListStrings.Assign(Source: TPersistent);
var
  I: Integer;
  ItemProp: TMyItemProp;
  SrcStrings: TStrings;
  ValStrings: TMyValueListStrings;
begin
  inherited;
  if Source is TMyValueListStrings then
  begin
    ValStrings := TMyValueListStrings(Source);
  ...
  begin
    ...
    { See if the source strings have TMyItemProp clases stored in the data }
    for I := 0 to Count - 1 do
    begin
      if (SrcStrings.Objects[I] <> nil) and
          (SrcStrings.Objects[I] is TMyItemProp) then
        ItemProps[I] := TMyItemProp(SrcStrings.Objects[I]);
    end;
  end;
end;

procedure TMyValueListStrings.Changing;
begin
  inherited;
...
procedure TMyValueListStrings.Changed;
begin
  inherited;
...
function TMyValueListStrings.KeyIsValid(const Key: string; RaiseError: Boolean = True): Boolean;
var
  Index: Integer;
begin
  Result := True;
...
procedure TMyValueListStrings.Clear;
var
  I: Integer;
begin
  inherited;
...
procedure TMyValueListStrings.CustomSort(Compare: TStringListSortCompare);
var
  I, OldIndex: Integer;
  OldOrder: TList;
  OldProps: TMyItemProps;
begin
...
procedure TMyValueListStrings.Delete(Index: Integer);
begin
  Changing;
  inherited;
  ...
  if Index < Count then
    System.Move(FItemProps[Index + 1], FItemProps[Index],
      (Count - Index) * SizeOf(TMyItemProp));
  SetLength(FItemProps, Count);
  Changed;
end;

procedure TMyValueListStrings.Exchange(Index1, Index2: Integer);
var
  Item: TMyItemProp;
begin
  Changing;
...
function TMyValueListStrings.FindItemProp(const KeyOrIndex: Variant;
  Create: Boolean = False): TMyItemProp;
var
  Index: Integer;
begin
  if Count > 0 then
  begin
    ...
    begin
      Result := TMyItemProp.Create(FEditor);
...
procedure TMyValueListStrings.InsertItem(Index: Integer; const S: string;
  AObject: TObject);
var
  OldCount: Integer;
begin
  ...
  if Index < OldCount then
    System.Move(FItemProps[Index], FItemProps[Index + 1],
      (OldCount - Index) * SizeOf(TMyItemProp));
  FItemProps[Index] := nil;
  Changed;
end;

function TMyValueListStrings.GeTMyItemProp(const KeyOrIndex: Variant): TMyItemProp;
begin
  Result := FindItemProp(KeyOrIndex, True);
end;

procedure TMyValueListStrings.Put(Index: Integer; const S: String);
var
  Name: string;
begin
  Name := ExtractName(S);
...
procedure TMyValueListStrings.PuTMyItemProp(const KeyOrIndex: Variant;
  const Value: TMyItemProp);
begin
...
constructor TMyItemProp.Create(AEditor: TMyValueListEditor);
begin
  FEditor := AEditor;
end;

destructor TMyItemProp.Destroy;
begin
  inherited;
  FPickList.Free;
end;

procedure TMyItemProp.AssignTo(Dest: TPersistent);
begin
  if Dest is TMyItemProp then
    with Dest as TMyItemProp do
    begin
...
procedure TMyItemProp.SetEditMask(const Value: string);
begin
  FEditMask := Value;
  UpdateEdit;
end;

procedure TMyItemProp.SetEditStyle(const Value: TEditStyle);
begin
  FEditStyle := Value;
  UpdateEdit;
end;

procedure TMyItemProp.SetKeyDesc(const Value: string);
begin
  FKeyDesc := Value;
end;

procedure TMyItemProp.SetMaxLength(const Value: Integer);
begin
  FMaxLength := Value;
  UpdateEdit;
end;

function TMyItemProp.HasPickList: Boolean;
begin
  Result := Assigned(FPickList) and (FPickList.Count > 0);
end;

function TMyItemProp.GetPickList: TStrings;
begin
...
procedure TMyItemProp.SetPickList(const Value: TStrings);
begin
  GetPickList.Assign(Value);
  UpdateEdit;
end;

procedure TMyItemProp.SetReadOnly(const Value: Boolean);
begin
  FReadOnly := Value;
  UpdateEdit;
end;

procedure TMyItemProp.UpdateEdit;
begin
...
procedure TMyItemProp.PickListChange(Sender: TObject);
begin
...
procedure Register;
begin
    RegisterComponents('Samples', [TMyValueListEditor])
end;

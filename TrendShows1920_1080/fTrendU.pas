...
//TrackBar для изменения значений по временной оси и TrackBar для увеличения по горизонтали
  ...
  TfTrend = class(TForm)
    ...
    procedure ImmiGraphTrBr18Change(Sender: TObject);
...
begin
 ...
 if (ExprGraphMulti1.Caption<>'Пусто') then
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti1.Caption)^.eu,[chart1.Series[0].YValues.Value[indx]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti2.Caption)^.eu,[chart1.Series[1].YValues.Value[indx]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti3.Caption)^.eu,[chart1.Series[2].YValues.Value[indx]]);
      end
    end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti4.Caption)^.eu,[chart1.Series[3].YValues.Value[indx]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti5.Caption)^.eu,[chart1.Series[4].YValues.Value[indx]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti6.Caption)^.eu,[chart1.Series[5].YValues.Value[indx]]);
       end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti7.Caption)^.eu,[chart1.Series[6].YValues.Value[indx]]);
      end
   end;
   ...
   begin
      ...
      format('%6.2f '+getTrdef.GetInfo(ExprGraphMulti8.Caption)^.eu,[chart1.Series[7].YValues.Value[indx]]);
      end else
      exit;
   end;
...
procedure TfTrend.FormShow(Sender: TObject);
begin
bNow.Click;
bLeft100Click(Sender);
//ImmiGraphTrBr13Change(ImmiGraphTrBr13);
bNow.Click;
bLeft100Click(Sender);
end;

procedure TfTrend.ImmiGraphTrBr18Change(Sender: TObject);
 var
   rectS: TRect;
begin
if chart1<>nil then
...
procedure TfTrend.Chart1Zoom(Sender: TObject);
begin
if chart1<>nil then
begin
Button1.Visible:=chart1.Zoomed;
end;
end;

procedure TfTrend.Button1Click(Sender: TObject);
begin
if chart1<>nil then
begin
chart1.UndoZoom;

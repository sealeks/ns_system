...
function CreateMethodPointer(TypeData: PTypeData): TMethod;
...
type
  ...
  TMyMethodHandlerInstance = class
  protected
...
function CreateMethodPointer(TypeData: PTypeData): TMethod;
begin
  Result.Data := TMyMethodHandlerInstance.Create(TypeData);
  Result.Code := @TMyMethodHandlerInstance.RegisterStub;
end;
...
constructor TMyMethodHandlerInstance.Create(
  TypeData: PTypeData);
var
  P: PChar;
  Offset: Integer;
...
destructor TMyMethodHandlerInstance.Destroy;
begin

  inherited;
end;

procedure TMyMethodHandlerInstance.Handler(Params: Pointer);
const
  MaxParams = 10;
var
  P: PChar;
...
begin
  ...
  begin
    ...
    if ParamInfos^[I]^.Kind = tkClass then
      ParamValues[TypeData^.ParamCount - I - 1] := variant(0)
...
procedure TMyMethodHandlerInstance.RegisterStub;
asm
        PUSH    EAX
        PUSH    ECX
        PUSH    EDX
    ...
    //    CALL    Handler
        ...
        POP     EAX
        POP     ECX		// Self
     //   LEA     ECX,[ECX].TMyMethodHandlerInstance.Return
